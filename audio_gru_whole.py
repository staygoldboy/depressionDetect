...
if __name__ == '__main__':
    ...
    train_idxs_tmps = [np.load(os.path.join(prefix, 'Features/TextWhole/train_idxs_0.51_1.npy'), allow_pickle=True),
    np.load(os.path.join(prefix, 'Features/TextWhole/train_idxs_0.72_2.npy'), allow_pickle=True),
    np.load(os.path.join(prefix, 'Features/TextWhole/train_idxs_0.65_3.npy'), allow_pickle=True)]
