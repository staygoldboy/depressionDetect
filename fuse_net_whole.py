...
prefix = os.path.abspath(os.path.join("D:/pywork/icassp2022-depression-main/DepressionCollected/Classification"))
...
audio_targets = np.where(audio_targets >= 53, 1, 0)
...
if __name__ == '__main__':
    idxs_paths = ['train_idxs_0.51_1.npy', 'train_idxs_0.72_2.npy', 'train_idxs_0.65_3.npy']
    text_model_paths = ['BiLSTM_128_0.73_1.pt', 'BiLSTM_128_0.80_2.pt', 'BiLSTM_128_0.67_3.pt']
    audio_model_paths = ['BiLSTM_gru_vlad256_256_0.51_1.pt', 'BiLSTM_gru_vlad256_256_0.72_2.pt', 'BiLSTM_gru_vlad256_256_0.65_3.pt']
